      ...
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            {Object.entries(battleResult.scores)
              .sort(([, a], [, b]) => b - a)
              .map(([userId, score], index) => {
                const player = players.find((p) => p.id === userId);
                const isWinner = userId === battleResult.winner_user_id;
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between rounded-lg p-5 transition-all ${
                      isWinner
                        ? "scale-105 bg-linear-to-r from-yellow-300 via-yellow-200 to-yellow-300 shadow-lg"
