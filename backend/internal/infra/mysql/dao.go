...
var tableColumns = map[TableName][]string{
	...
	BattlesTable:     {"id", "room_id", "started_at", "theme", "battle_time_limit_seconds", "current_phase", "selecting_started_at", "clap_phase_started_at", "clap_current_user_index", "result_started_at"},
